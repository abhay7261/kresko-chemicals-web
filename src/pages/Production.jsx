    ...
    <div>
      ...
      <section className="solution-banner" style={{ backgroundImage: "url('/images/photo-1528218609959-006f98e6b79e.jpeg')", padding: "5rem 0" }}>
        <div className="container solution-content">
          <h2>Our Chemical Production & Lab</h2>
          <p>State-of-the-art surfactant blending, pH testing, and customized private labeling systems.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem auto' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.8rem, 5vw, 2.5rem)', fontWeight: 900, color: 'var(--color-primary)' }}>
              Manufacturing & Lab Capabilities
            </h2>
            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem', lineHeight: '1.7' }}>
              Our Ahmedabad facility houses advanced stainless steel chemical reactors, blending tanks, and high-precision testing loops where we formulate bulk cleaning concentrates for national distribution.
            </p>
          </div>
          ...
          <div className="company-feature-row">
            ...
            <div>
              ...
              <ul className="company-feature-list">
                ...
                <li><span className="check-icon"><i className="fa-solid fa-check"></i></span> Strict physical segregation for eco-friendly concentrates</li>
              </ul>
          ...
          <div className="company-feature-row reverse-mobile">
            <div>
              ...
              <Link to="/contact?product=Quality+Control+Lab+Enquiry" className="btn btn-primary" style={{ borderRadius: '8px', padding: '0.75rem 1.5rem', fontSize: '0.85rem', fontWeight: 800, marginTop: '0.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
